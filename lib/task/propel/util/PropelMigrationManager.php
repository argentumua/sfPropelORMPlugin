...
require_once dirname(__FILE__) . '/../../../vendor/propel/generator/lib/model/Table.php';
require_once dirname(__FILE__) . '/../../../vendor/propel/generator/lib/model/Column.php';
require_once dirname(__FILE__) . '/../../../vendor/propel/generator/lib/util/PropelSQLParser.php';
...
class PropelMigrationManager
{
    ...
    public function getPlatform($datasource)
    {
        ...
        require_once sprintf('%s/../../../vendor/propel/generator/lib/platform/%s.php',
            dirname(__FILE__),
            $adapterClass
        );
